...
import { saidaFormFields, FieldConfig } from '../../config/formFields';
...
export const SaidaForm: React.FC<SaidaFormProps> = ({ enderecoOrigem }) => {
  const [formData, setFormData] = useState<SaidaEstoque>({
    param: {
      endereco_de: '',
      quantidade: 0,
